...
public partial class UpdateChampionshipPage : ContentPage, IQueryAttributable
{
	private readonly UpdateChampionshipViewModel _viewModel;
	public UpdateChampionshipPage(UpdateChampionshipViewModel viewModel)
	{
		InitializeComponent();
    ...
    private async void OnShellNavigating(object sender, ShellNavigatingEventArgs e)
    {
        ...
        if (_viewModel.ChampionshipEdited)
        {
            e.Cancel();
            ...
            _viewModel.ChampionshipEdited = false;
